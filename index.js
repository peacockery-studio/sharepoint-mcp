#!/usr/bin/env node
/**
 * SharePoint MCP Server - Main entry point
 *
 * A Model Context Protocol server that provides access to
 * Microsoft SharePoint through the Microsoft Graph API.
 */
...
const { documentTools } = require("./document");
...
// Combine all tools
const TOOLS = [...authTools, ...folderTools, ...documentTools];
